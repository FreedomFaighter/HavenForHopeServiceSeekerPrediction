...
for (i in 1:length(uniq)) {
  ...
  write.csv(outputDFs[[i]], file = paste("Exponential", uniq[i], ".csv", sep = ""))
  png(paste("Exponential", uniq[i], ".png", sep = ""))
  plot(productsPrediction[[i]])
  dev.off()
} 
